  ...
  return (
    <div className="space-y-1">
      {files.map((f) => {
        ...
        return (
          <div key={f.id} className="group flex items-center gap-3 rounded-xl border border-transparent px-4 py-3 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] hover:border-white/10 hover:bg-white/[0.04]">
